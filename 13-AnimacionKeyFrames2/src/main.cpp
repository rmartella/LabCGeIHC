...
float rotBuzzHead = 0.0, rotBuzzHip = 0.0, rotBuzzRightArm1 = 0.0, rotBuzzRightArm2 = 0.0, rotBuzzRightForeArm = 0.0,
		rotBuzzRightHand = 0.0, rotBuzzRightThigh = 0.0, rotBuzzRightCalf = 0.0, rotBuzzRightFoot = 0.0;
float offsetBuzzWings = 0.0;
int modelSelected = 0;
...
void applicationLoop() {
	...
	while (psi) {
		...
		glm::mat4 modelMatrixBody = glm::mat4(modelMatrixDart);
		modelMatrixBody = glm::scale(modelMatrixBody, glm::vec3(0.5, 0.5, 0.5));
		modelDartLegoBody.render(modelMatrixBody);
		glm::mat4 modelMatrixDartHead = glm::mat4(modelMatrixBody);
		...
		glm::mat4 modelMatrixDartLeftArm = glm::mat4(modelMatrixBody);
		...
		glm::mat4 modelMatrixDartRightArm = glm::mat4(modelMatrixBody);
		...
		glm::mat4 modelMatrixDartLeftLeg = glm::mat4(modelMatrixBody);
		...
		glm::mat4 modelMatrixDartRightLeg = glm::mat4(modelMatrixBody);
		...
		glm::mat4 modelMatrizHip = glm::mat4(modelMatrixBuzz);
		modelMatrizHip = glm::rotate(modelMatrizHip, rotBuzzHip, glm::vec3(0, 1, 0));
		modelBuzzHip.render(modelMatrizHip);

		glm::mat4 modelMatrizRightArm = glm::mat4(modelMatrixTorso);
		modelMatrizRightArm = glm::translate(modelMatrizRightArm, glm::vec3(-0.179974, 0.577592, -0.022103));
		modelMatrizRightArm = glm::rotate(modelMatrizRightArm, rotBuzzRightArm1, glm::vec3(1, 0, 0));
		modelMatrizRightArm = glm::rotate(modelMatrizRightArm, rotBuzzRightArm2, glm::vec3(0, 0, 1));
		modelMatrizRightArm = glm::translate(modelMatrizRightArm, glm::vec3(0.179974, -0.577592, 0.022103));
		modelBuzzRightArm.render(modelMatrizRightArm);
		glm::mat4 modelMatrizRightForearm = glm::mat4(modelMatrizRightArm);
		modelMatrizRightForearm = glm::translate(modelMatrizRightForearm, glm::vec3(-0.298368, 0.583773, 0.008465));
		modelMatrizRightForearm = glm::rotate(modelMatrizRightForearm, rotBuzzRightForeArm, glm::vec3(0, 1, 0));
		modelMatrizRightForearm = glm::translate(modelMatrizRightForearm, glm::vec3(0.298368, -0.583773, -0.008465));
		modelBuzzRightForearm.render(modelMatrizRightForearm);
		glm::mat4 modelMatrizRightHand = glm::mat4(modelMatrizRightForearm);
		modelMatrizRightHand = glm::translate(modelMatrizRightHand, glm::vec3(-0.416066, 0.587046, 0.076258));
		modelMatrizRightHand = glm::rotate(modelMatrizRightHand, glm::radians(45.0f), glm::vec3(0, 1, 0));
		modelMatrizRightHand = glm::rotate(modelMatrizRightHand, rotBuzzRightHand, glm::vec3(1, 0, 0));
		modelMatrizRightHand = glm::rotate(modelMatrizRightHand, glm::radians(-45.0f), glm::vec3(0, 1, 0));
		modelMatrizRightHand = glm::translate(modelMatrizRightHand, glm::vec3(0.416066, -0.587046, -0.076258));
		modelBuzzRightHand.render(modelMatrizRightHand);
		glm::mat4 modelMatrizRightWings = glm::mat4(1.0f);
		modelMatrizRightWings = glm::translate(modelMatrixTorso, glm::vec3(offsetBuzzWings, 0.0, 0.0));
		modelBuzzRightWing1.render(modelMatrizRightWings);
		modelMatrizRightWings = glm::translate(modelMatrixTorso, glm::vec3(2.0 * offsetBuzzWings, 0.0, 0.0));
		modelBuzzRightWing2.render(modelMatrizRightWings);
		glm::mat4 modelMatrizRightThigh = glm::mat4(modelMatrizHip);
		modelMatrizRightThigh = glm::translate(modelMatrizRightThigh, glm::vec3(-0.063347, 0.355292, 0.010264));
		modelMatrizRightThigh = glm::rotate(modelMatrizRightThigh, rotBuzzRightThigh, glm::vec3(1, 0, 0));
		modelMatrizRightThigh = glm::translate(modelMatrizRightThigh, glm::vec3(0.063347, -0.355292, -0.010264));
		modelBuzzRightThigh.render(modelMatrizRightThigh);
		glm::mat4 modelMatrizRightCalf = glm::mat4(modelMatrizRightThigh);
		modelMatrizRightCalf = glm::translate(modelMatrizRightCalf, glm::vec3(-0.06531, 0.214925, -0.010299));
		modelMatrizRightCalf = glm::rotate(modelMatrizRightCalf, rotBuzzRightCalf, glm::vec3(1, 0, 0));
		modelMatrizRightCalf = glm::translate(modelMatrizRightCalf, glm::vec3(0.06531, -0.214925, 0.010299));
		modelBuzzRightCalf.render(modelMatrizRightCalf);
		glm::mat4 modelMatrizRightFoot = glm::mat4(modelMatrizRightCalf);
		modelMatrizRightFoot = glm::translate(modelMatrizRightFoot, glm::vec3(-0.071529, 0.083331, -0.026461));
		modelMatrizRightFoot = glm::rotate(modelMatrizRightFoot, rotBuzzRightFoot, glm::vec3(1, 0, 0));
		modelMatrizRightFoot = glm::translate(modelMatrizRightFoot, glm::vec3(0.071529, -0.083331, 0.026461));
		modelBuzzRightFoot.render(modelMatrizRightFoot);

		glm::mat4 modelMatrizLeftArm = glm::mat4(modelMatrixTorso);
		modelBuzzLeftArm.render(modelMatrizLeftArm);
		glm::mat4 modelMatrizLeftForearm = glm::mat4(modelMatrizLeftArm);
		modelBuzzLeftForearm.render(modelMatrizLeftForearm);
		glm::mat4 modelMatrizLeftHand = glm::mat4(modelMatrizLeftForearm);
		modelBuzzLeftHand.render(modelMatrizLeftHand);
		glm::mat4 modelMatrizLeftWings = glm::mat4(1.0f);
		modelMatrizLeftWings = glm::translate(modelMatrixTorso, glm::vec3(-offsetBuzzWings, 0.0, 0.0));
		modelBuzzLeftWing1.render(modelMatrizLeftWings);
		modelMatrizLeftWings = glm::translate(modelMatrixTorso, glm::vec3(-2.0f * offsetBuzzWings, 0.0, 0.0));
		modelBuzzLeftWing2.render(modelMatrizLeftWings);
		glm::mat4 modelMatrizLeftThigh = glm::mat4(modelMatrizHip);
		modelBuzzLeftThigh.render(modelMatrizLeftThigh);
		glm::mat4 modelMatrizLeftCalf = glm::mat4(modelMatrizLeftThigh);
		modelBuzzLeftCalf.render(modelMatrizLeftCalf);
		glm::mat4 modelMatrizLeftFoot = glm::mat4(modelMatrizLeftThigh);
		modelBuzzLeftFoot.render(modelMatrizLeftFoot);
		...
		if(record && modelSelected == 3){
			...
			rotBuzzRightCalf = interpolate(keyFramesBuzzJoints, indexFrameBuzzJoints, indexFrameBuzzJointsNext, 7, interpolationBuzzJoints);
			rotBuzzRightFoot = interpolate(keyFramesBuzzJoints, indexFrameBuzzJoints, indexFrameBuzzJointsNext, 8, interpolationBuzzJoints);
		}
